...
def collect_stats(tx_csv, blocks_csv, tx_plus_csv):
    ...
    with open(tx_plus_csv, "w") as f:
        f.write("tx_hash,submitted_at,block1,my1,block2,my2,block3,my3,block4,my4,block5,my5,block6,my6,block7,my7,block8,my8,block9,my9,block10,my10,block11,my11,block12,my12,gas_used\n")
